defmodule Morse do
  ...
  def decode([?- | r], {:node,_, long,_}, table) do
    decode(r, long, table)
  end
  def decode([?. | r], {:node,_,_, short}, table) do
    decode(r, short, table)
  end
  def decode([?\s | r], {:node, char,_,_}, table) do
    [char| decode(char,table,table)]
  end
